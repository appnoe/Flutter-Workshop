...
class TVMazeResult {
  ...
  TVMazeResult({this.score, this.show});

  TVMazeResult.fromJson(Map<String, dynamic> json) {
    score = json['score'];
  ...
  static List<TVMazeResult> fromJsonArray(dynamic jsonArray) {
    List<dynamic> stringList = jsonDecode(jsonArray);
    return stringList.map((e) => TVMazeResult.fromJson(e)).toList();
  }
}
